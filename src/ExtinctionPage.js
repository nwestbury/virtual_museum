            ...
            <Grid container spacing={24}>
                ...
                <Grid item sm={12} md={6}>
                  ...
                  <Typography variant="subtitle1" align="left">
                    People all around the world are concerned about
                    <Dialog title="climate change" def="Climate change is when the Earth’s climate changes such as a change in the Earth’s usual temperature (NASA, 2017)." /> and
