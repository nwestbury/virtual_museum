            ...
            <Grid container spacing={24}>
                ...
                <Grid item sm={12} md={6}>
                  ...
                  <Typography variant="subtitle1" align="left">
                     <i>Bothriolepis</i> is a genus of extinct fishes that are characteristic of the middle and late Devonian period (387 million- 360 million years ago). They belong to the order Antiarcha, and the class Placodermi, with about hundreds of different fossil species found all around the world (Johanson, 1998). They lived in warm and dry conditions during the Devonian period (Bagley, 2014; Miguasha National Park, 2007). In 1840, Karl Eichwald, a German geologist, physician and a naturalist introduced the name <i>Bothriolepis</i> from the Novgorod region of present-day Russia (Bechard et.al., 2014). <i>Bothriolepis</i> were detritivores, meaning they feed on decomposing organic matter. They fed on a diet of mud, microorganisms, and algae as evidenced by “carbonaceous material” and “fine muddy or silty stone usually present in the posterior alimentary tract” (Denison, 1941). Based on the ventral position of the mouth, Robert Dension, a paleontologist determined that <i>Bothriolepis</i> was likely a bottom feeder.
                  </Typography>
                </Grid>
                <Grid item sm={12} md={6} className={classes.flex}>
                  <Card className={classes.card + ' ' + classes.flexVCenter}>
